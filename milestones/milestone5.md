...
Deploying the final touches and connecting the React frontend directly through our Express backend went smoothly. Our team did a great job coordinating to ensure all custom features worked correctly before deploying.

### 2. What were some challenges your group faced in this unit?

Setting up the deployment pipeline to build both the frontend and run the backend concurrently on a single Render Web Service was tricky, but we resolved it by adjusting our Node environment variables and static file routing.

### 3. What were some of the highlights or achievements that you are most proud of in this project?

We are most proud of our custom Date collision validation for reservations and the real-time client-side filtering on the Explore page. Seeing it all come together with a premium UI design was extremely rewarding!

### 4. Reflecting on your web development journey so far, how have you grown since the beginning of the course?

At the beginning of the course, setting up a simple React component or Express route felt daunting. Now, we're comfortably building full-stack applications with relational databases, dynamic routing, and complex state management.

### 5. Looking ahead, what are your goals related to web development, and what steps do you plan to take to achieve them?

Our goals are to dive deeper into performance optimization, authentication (like OAuth), and more advanced backend architectures. We plan to continue building side projects and contributing to open source to solidify our skills.
